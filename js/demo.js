...
demo.controller('demoController', function($scope, sweet, $interval, $timeout, $http) {
        ...
        sweet.show({
            ...
            $http.get('data.json')
                .success(function (response){
                    ...
                    sweet.show('Get', 'You have benn gotten.', 'success');
                }).error(function (response){
                    console.log(response);
                    sweet.show('Error', 'Something Wrong', 'error');
